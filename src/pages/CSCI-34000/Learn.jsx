...
const Learn = () => {
  return (
    <>
      ...
      <motion.div
        className="lg:w-[90%] w-[80%] mx-auto my-8"
        initial={{ opacity: 0, x: -50 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 1, delay: 0.2 }}
        viewport={{ once: true }}
      >
        <h2 className="lg:text-4xl xl:text-5xl text-3xl text-center font-[googleSansBold] my-6 lg:my-8">
          Available Lessons:
        </h2>
          ...
          {lessonData.map((lesson) => (
            <NavLink
              ...
              className={
                ...
                `block w-full text-center px-4 py-3 border-2 
