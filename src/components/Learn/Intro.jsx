      ...
      <div className="min-h-[87svh]">
        <div className="lg:w-[90%] mt-10 w-[80%] mx-auto lg:flex lg:space-y-0 space-y-10 flex-wrap items-center justify-between">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h1 className="lg:text-4xl xl:text-5xl text-3xl font-[googleSansBold] mb-2">CSCI 34000</h1>
            <h2 className="lg:text-3xl xl:text-4xl text-2xl font-[googleSansBold] mb-8">Operating Systems</h2>
            <h3 className="lg:text-2xl xl:text-3xl text-lg font-[googleSansMedium]">
